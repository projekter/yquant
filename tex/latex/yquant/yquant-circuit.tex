...
\protected\def\yquant@circuit@output{%
   ...
   \ifnum\yquant@compat>1 %
      \let\Ifnum=\yquant@circuit@output@protected%
      \let\Ifcase=\yquant@circuit@output@protected%
      \let\Or=\yquant@circuit@output@protected%
      \let\Else=\yquant@circuit@output@protected%
      \let\Fi=\yquant@circuit@output@protected%
      \let\Unless=\yquant@circuit@output@protected%
      \let\The=\yquant@circuit@output@protected%
   \fi%
...
\ifnum\yquant@compat>1 %
   \protected\def\yquant@circuit@output@protected{}
\fi%
% END_FOLD