...
\ifdefined\beamer@masterdecode
   \newcommand<>\yquant@circuit@startenclose[2][]{%
      \yquant@config@enclose@beamercommand#3{\yquant@circuit@startenclose@i[{#1}]{#2}}%
   }
\else
...
\def\yquant@circuit@startenclose@i[#1]#2{%
   \begingroup%
      ...
      % this is undefined anyway if beamer is not loaded, so no harm:
   ...
   \begingroup%
      ...
      \ifnum\csname yquant@circuit@enclose@#1@shape\endcsname=0 %
         ...
         \expandafter\ifx\csname yquant@circuit@enclose@#1@involved\endcsname\yquant@circuit@enclose@allinvolved%
            \expandafter\yquant@circuit@align\expandafter{\romannumeral-`0\yquant@list@range{1}{\csname\yquant@prefix registers\endcsname\space}}%
         \else%
...
\ifdefined\beamer@masterdecode
   ...
   \long\def\yquant@circuit@enclose@ii#1#2[#3]#4{%
      \begingroup%
         \expandafter\ifyquant@firsttoken\expandafter\only\expandafter{\yquant@config@enclose@beamercommand}{%
            \yquant@config@enclose@beamercommand#2{\yquant@circuit@startenclose@i[{#3}]\relax}%
            \yquant@env@scan#4%
            \yquant@config@enclose@beamercommand#2{\yquant@circuit@stopenclose@i{#1}}%
         }{%
   ...
   \long\def\yquant@circuit@encloseall@i#1#2[#3]#4{%
      \begingroup%
         \expandafter\ifyquant@firsttoken\expandafter\only\expandafter{\yquant@config@enclose@beamercommand}{%
            \yquant@config@enclose@beamercommand#2{\yquant@circuit@encloseall@start{#1}{#3}}%
            \yquant@env@scan#4%
            \yquant@config@enclose@beamercommand#2{\yquant@circuit@stopenclose@i{#1}}%
         }{%
            \edef\yquant@circuit@enclose@currentbeamercommand{\unexpanded\expandafter{\yquant@config@enclose@beamercommand}#2}%
...
\def\yquant@circuit@encloseall@start#1#2{%
   ...
   % we don't add it to the active list as we don't have to keep track of anything here
...
\protected\def\yquant@circuit@enclose@update@extentTB@i#1#2#3#4{%
   ...
   % #4: enclose id
   % Note that this is not invoked for encloseall
   \begingroup%
