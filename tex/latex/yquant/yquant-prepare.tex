...
% TODO: We need to somehow provide meaningful nodes for every named gate. We don't know about the y positions, so we cannot do anything about it. But we know the x positions and should set them appropriately (and unless some bend-paths are used, this should be sufficient).
