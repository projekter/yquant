...
% BEGIN_FOLD Enclose styles
   ...
   enclose/name/.belongs to family=/yquant/enclose/options,%
   enclose/from/.code=%
   ...
   enclose/from/.belongs to family=/yquant/enclose/options,
   enclose/to/.code=%
      {\expandafter\yquant@register@singleget%
   ...
   enclose/to/.belongs to family=/yquant/enclose/options,%
   enclose/spacing/.is choice,%
   enclose/spacing/.belongs to family=/yquant/enclose/options,%
   enclose/spacing/register/.code={\def\yquant@config@enclose@spacing{0}},%
   enclose/spacing/register/.belongs to family=/yquant/enclose/options,%
   enclose/spacing/gate/.code={\def\yquant@config@enclose@spacing{1}},%
   enclose/spacing/gate/.belongs to family=/yquant/enclose/options,%
   enclose/spacing/gate or local register/.code={\def\yquant@config@enclose@spacing{2}}%,
   enclose/spacing/gate or local register/.belongs to family=/yquant/enclose/options,%
   enclose/shape/.is choice,%
   enclose/shape/.belongs to family=/yquant/enclose/options,%
   enclose/shape/rectangle/.code={\def\yquant@config@enclose@shape{0}},%
   enclose/shape/rectangle/.belongs to family=/yquant/enclose/options,%
   enclose/shape/polygon/.code={\def\yquant@config@enclose@shape{1}},%
   enclose/shape/polygon/.belongs to family=/yquant/enclose/options,%
   ...
   enclose style/.style={/yquant/every enclose/.append style={#1}},%
   every braced enclose/.style={draw=none},
   braced enclose style/.style={/yquant/every braced enclose/.append style={#1}},%
   enclose layer/.initial=background,%
   enclose label layer/.initial=main,%
   enclose/shape/polygon/points/.initial,%
   enclose/overlay command/.store in=\yquant@config@enclose@beamercommand,%
   /tikz/.cd,
   enclose/brace above/.code={\pgfkeysalso{/yquant/every braced enclose}\yquant@config@enclose@brace0{#1}},%
   enclose/brace below/.code={\pgfkeysalso{/yquant/every braced enclose}\yquant@config@enclose@brace1{#1}},%
   enclose/brace left/.code={\pgfkeysalso{/yquant/every braced enclose}\yquant@config@enclose@brace0{#1}},%
   enclose/brace right/.code={\pgfkeysalso{/yquant/every braced enclose}\yquant@config@enclose@brace1{#1}},%
   enclose/every brace label/.style={label distance=2pt},%
   enclose/every brace label above or left/.style={},%
   enclose/every brace label below or right/.style={},%
   enclose/every brace label above/.style={},%
   enclose/every brace label below/.style={},%
   enclose/every brace label left/.style={},%
   enclose/every brace label right/.style={},%
   enclose/brace label style/.style={/tikz/enclose/every brace label/.append style={#1}},%
   enclose/brace label above or left style/.style={/tikz/enclose/every brace label above or left/.append style={#1}},%
   enclose/brace label below or right style/.style={/tikz/enclose/every brace label below or right/.append style={#1}},%
   enclose/brace label above style/.style={/tikz/enclose/every brace label above/.append style={#1}},%
   enclose/brace label below style/.style={/tikz/enclose/every brace label below/.append style={#1}},%
   enclose/brace label left style/.style={/tikz/enclose/every brace label left/.append style={#1}},%
   enclose/brace label right style/.style={/tikz/enclose/every brace label right/.append style={#1}},%
   enclose/brace style/.style={/pgf/decoration/enclose/every brace/.append style={#1}},%
   enclose/brace style above or left/.style={/pgf/decoration/enclose/every brace above or left/.append style={#1}},%
   enclose/brace style below or right/.style={/pgf/decoration/enclose/every brace below or right/.append style={#1}},%
   enclose/brace style above/.style={/pgf/decoration/enclose/every brace above/.append style={#1}},%
   enclose/brace style below/.style={/pgf/decoration/enclose/every brace below/.append style={#1}},%
   enclose/brace style left/.style={/pgf/decoration/enclose/every brace left/.append style={#1}},%
   enclose/brace style right/.style={/pgf/decoration/enclose/every brace right/.append style={#1}},%
   /pgf/decoration/.cd,
   enclose/every brace/.style={brace},%
   enclose/every brace above or left/.style={},%
   enclose/every brace below or right/.style={},%
   enclose/every brace above/.style={},%
   enclose/every brace below/.style={mirror},%
   enclose/every brace left/.style={mirror},%
   enclose/every brace right/.style={},%
}
   ...
   \begingroup%
      \edef\yquant@config@enclose@brace@style{%
         ...
         \noexpand\pgfkeysalso{%
            ...
            \noexpand\draw[name prefix=, name suffix=, decoration=/yquant/internal/collected brace decoration \yquant@config@enclose@braces,%
                           decorate]%
               \ifnum#1=0 %
...
\protected\def\yquant@config@enclose@collectbracestyles#1#2{%
   \csxdef{pgfk@/yquant/internal/collected brace decoration #2/.@cmd}##1\pgfeov{%
      \unexpanded\expandafter\expandafter\expandafter{\csname pgfk@/pgf/decoration/enclose/every brace/.@cmd\endcsname##1\pgfeov}%
      \unexpanded\expandafter\expandafter\expandafter{\csname pgfk@/pgf/decoration/enclose/every brace \ifnum#1=0 above or left\else below or right\fi/.@cmd\endcsname##1\pgfeov}%
      \unexpanded\expandafter\expandafter\expandafter{\csname pgfk@/pgf/decoration/enclose/every brace \ifnum#1=0 \ifyquanthorz{above}{left}\else\ifyquanthorz{below}{right}\fi/.@cmd\endcsname##1\pgfeov}%
   }%
   \csxdef{pgfk@/yquant/internal/collected brace label #2/.@cmd}##1\pgfeov{%
      \unexpanded\expandafter\expandafter\expandafter{\csname pgfk@/tikz/enclose/every brace label/.@cmd\endcsname##1\pgfeov}%
      \unexpanded\expandafter\expandafter\expandafter{\csname pgfk@/tikz/enclose/every brace label \ifnum#1=0 above or left\else below or right\fi/.@cmd\endcsname##1\pgfeov}%
      \unexpanded\expandafter\expandafter\expandafter{\csname pgfk@/tikz/enclose/every brace label \ifnum#1=0 \ifyquanthorz{above}{left}\else\ifyquanthorz{below}{right}\fi/.@cmd\endcsname##1\pgfeov}%
   }%
}
% END_FOLD
