...
\pgfqkeys{/yquant}{%
   ...
   circuit/direction/.is choice,%
   circuit/direction/horizontal/.code={%
      \ifyquant@config@circuitsetup%
         \yquant@config@circuit@direction@horizontal%
      \else%
         \PackageError{yquant.sty}{`circuit/direction' can only be modified in the environment options or globally.}{Don't modify this within a circuit.}
      \fi%
   },%
   circuit/direction/vertical/.code={%
      \ifyquant@config@circuitsetup%
         \yquant@config@circuit@direction@vertical%
      \else%
         \PackageError{yquant.sty}{`circuit/direction' can only be modified in the environment options or globally.}{Don't modify this within a circuit.}
      \fi%
   },%
...
\protected\def\yquant@config@circuit@direction@horizontal{%
   ...
   \def\yquant@direction@x{x}%
   \def\yquant@direction@y{y}%
   \def\yquant@direction@plus{+}%
   \def\yquant@direction@minus{-}%
}

\protected\def\yquant@config@circuit@direction@vertical{%
   ...
   \def\yquant@direction@x{y}%
   \def\yquant@direction@y{x}%
   \def\yquant@direction@plus{-}%
   \def\yquant@direction@minus{+}%
}
