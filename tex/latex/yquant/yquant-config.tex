...
\pgfqkeys{/yquant}{%
   ...
   operators/every subcircuit box/.style=%
      {/yquant/operators/every box, inner xsep=0pt},%
   ...
   operators/subcircuit/frameless/.style=
      {/yquant/operators/this subcircuit box/.append style={draw=none, inner ysep=0pt}},
   operators/subcircuit/seamless/.code=%
      {\pgfkeysalso{/yquant/subcircuit/frameless}%
