...
% BEGIN_FOLD Enclose styles
   ...
   every brace label/.style={label distance=2pt},%
   ...
   every brace/.style={/pgf/decoration/brace, decorate},%
   every brace above or left/.style={},%
   every brace below or right/.style={},%
   every brace above/.style={},%
   every brace below/.style={/pgf/decoration/mirror},%
   every brace left/.style={/pgf/decoration/mirror},%
   every brace right/.style={},%
   ...
   \begingroup%
      \edef\yquant@config@enclose@brace@style{%
         ...
         \noexpand\pgfkeysalso{%
            ...
            \noexpand\draw[/yquant/internal/collected brace decoration \yquant@config@enclose@braces, /tikz/name prefix=, /tikz/name suffix=]%
               \ifnum#1=0 %
...
\pgfqkeys{/yquant}{%
   ...
   internal/maybe move label/.code 2 args={%
      ...
      \csshow{ifyquant@config@operator@position@rightalign}%
