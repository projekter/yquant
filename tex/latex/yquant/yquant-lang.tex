...
\yquant@langhelper@setup@attrs{correlate}{}{value}
\def\yquant@lang@@correlate{%
   \yquant@register@get@allowmultitrue%
   \appto\yquant@attrs@remaining{/yquant/operators/every wave line,}%
   \edef\cmd{%
      \noexpand\yquant@draw%
         {}%
         {/yquant/operators/every wave%
          \ifdefined\yquant@lang@attr@value,
             label={\unexpanded\expandafter{\yquant@lang@attr@value}},
             label position=left%
          \fi}{}{}%
   }%
   \cmd%
