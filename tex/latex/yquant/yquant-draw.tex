...
\protected\long\def\yquant@draw@subcircuit@prepare#1#2#3#4#5{%
   ...
   \yquant@begingroup%
      ...
      \ifdim\dimexpr\delta\yquant@orientation@minus100sp\relax\ifyquanthorz><0pt %
         ...
         \dimdef\yquant@draw@@x{\yquant@draw@@x+.5\dimexpr\delta\relax}%
         \dimdef\yquant@draw@@width{\yquant@draw@@width\yquant@orientation@plus\delta}%
         \advance \dimen6 by \yquant@orientation@plus\delta\space%
      \fi%
      \edef\cmd{%
