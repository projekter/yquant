...
\protected\long\def\yquant@draw@@subcircuit#1{%
   \yquant@sort@clear%
   \def\idx{0}%
   % before going into the subcircuits, we globally determine the extra height due to inner separation of the subcircuit box
   \pgfinterruptboundingbox%
      ...
      \edef\tmp{%
         \def\noexpand\yquant@draw@@subcircuit@extent{%
            {\the\dimexpr\pgf@picmaxy-\pgf@y\relax}{\the\dimexpr\pgf@y-\pgf@picminy\relax}%
         }%
      }%
      \expandafter%
   \endpgfinterruptboundingbox%
...
\protected\def\yquant@draw@@subcircuit@single#1#2{%
   ...
   \expandafter\yquant@circuit@subcircuit\expandafter{\yquant@draw@@subcircuit@extent}{#1}%
   \yquant@sort@eadd{%
