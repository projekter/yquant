...
\protected\def\yquant@register@define#1#2#3#4{%
   ...
   \csxdef{\yquant@prefix register@\csname\yquant@prefix registers\endcsname}{%
      ...
      {}% wire style
      {}% information about the last gate
   }%
...
\def\yquant@register@get@lastgate#1{%
   \ifcsname\yquant@prefix registermap@#1\endcsname%
      \expandafter\expandafter\expandafter%
      \yquant@register@get@lastgate@aux\csname\csname\yquant@prefix registermap@#1\endcsname\endcsname%
   \else%
      \expandafter\expandafter\expandafter%
      \yquant@register@get@lastgate@aux\csname\yquant@prefix register@#1\endcsname%
   \fi%
}

\def\yquant@register@get@lastgate@aux#1#2#3#4#5#6{#6}

\def\ifyquant@register@lastgate@empty#1{%
   \ifcsname\yquant@prefix registermap@#1\endcsname%
      \expandafter\expandafter\expandafter%
      \ifyquant@register@lastgate@empty@aux\csname\csname\yquant@prefix registermap@#1\endcsname\endcsname%
   \else%
      \expandafter\expandafter\expandafter%
      \ifyquant@register@lastgate@empty@aux\csname\yquant@prefix register@#1\endcsname%
   \fi%
}

\def\ifyquant@register@lastgate@empty@aux#1#2#3#4#5#6{\ifstrempty{#6}}
...
\long\def\yquant@register@set@typex@aux#1#2#3#4#5#6#7{%
   #7\unexpanded{{#3}{#4}{#5}{#6}}%
}
