...
\protected\def\yquant@register@define#1#2#3{%
   ...
   \csxdef{\yquant@prefix register@\csname\yquant@prefix registers\endcsname}{%
      ...
      {{\yquant@config@register@minimum@height}%
       ...
       {}}% height, depth, and multi-space parts; at the end, multispace is overwritten by the y position
...
\let\yquant@register@get@y@aux=\yquant@register@get@multispace@aux
...
\let\yquant@register@set@y@aux=\yquant@register@set@multispace@aux
