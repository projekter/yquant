...
\protected\def\yquant@register@define#1#2#3{%
   ...
   \csxdef{\yquant@prefix register@\csname\yquant@prefix registers\endcsname}{%
      ...
      {}% wire style
      {\yquant@register@get@clean@}% information about the last gate
   }%
...
\protected\def\yquant@register@alias#1#2#3#4{%
   ...
   \expandafter\yquant@register@set@@aux%
      ...
      \yquant@register@set@xlastgate@aux%
      {{\csname\yquant@prefix xshift\endcsname}{\yquant@register@get@clean@}}%
}
...
\long\def\yquant@register@execclear@lastgate#1#2{%
   \ifcsname\yquant@prefix registermap@#1\endcsname%
      \expandafter%
      \yquant@register@execclear@lastgate@aux@i\csname\csname\yquant@prefix registermap@#1\endcsname\endcsname{#2}%
   \else%
      \expandafter%
      \yquant@register@get@lastgate@aux@i\csname\yquant@prefix register@#1\endcsname{#2}%
   \fi%
}
...
\long\def\yquant@register@execclear@lastgate@aux@ii#1#2#3#4#5#6#7#8{%
   \ifstrempty{#6}\relax{%
      #6{#8}%
      \xdef#7{\unexpanded{#1#2#3#4#5{\@gobble}}}%
   }%
}
...
% Executes #2 if all registers in the list #1 are clean (= freshly created or aliased), else executes #3
\protected\def\yquant@register@get@clean#1{%
   \let\next=\@secondoftwo%
   \forlistloop\yquant@register@get@clean@loop{#1}%
   \next%
}

\protected\def\yquant@register@get@clean@loop#1{%
   \let\next=\@secondoftwo%
   \yquant@register@execclear@lastgate{#1}{}%
   \ifx\next\@secondoftwo%
...
\long\def\yquant@register@set@xlastgate@aux#1#2#3#4#5#6#7{%
   \unexpanded{{#1}}{\@firstoftwo#7}\unexpanded{{#3}{#4}{#5}}{\@secondoftwo#7}%
}
