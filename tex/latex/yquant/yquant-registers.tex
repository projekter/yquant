...
\protected\def\yquant@register@inject@extents#1#2{%
   ...
   \expandafter\yquant@register@set@@aux%
      ...
      \yquant@register@inject@extents@aux{{#1}{#2}}%
}

\long\def\yquant@register@inject@extents@aux#1#2#3#4#5#6{%
   \unexpanded{{#1}{#2}}%
   {{\the\dimexpr\@firstofthree#3+\@firstoftwo#6\relax}%
    {\the\dimexpr\@secondofthree#3+\@secondoftwo#6\relax}%
    {\unexpanded\expandafter{\@thirdofthree#3}}}%
   \unexpanded{{#4}{#5}}%
}
