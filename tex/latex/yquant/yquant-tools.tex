...
\protected\def\yquant@softpath@extractmaxxat#1#2{%
   \begingroup%
      \dimen0=\yquant@direction@minus16000pt %
      \dimen2=#2 %
      \pgftransforminvert%
...
\protected\def\yquant@softpath@extractmaxxat@update#1{%
   \ifdim\yquant@direction@plus\dimen0<\yquant@direction@plus#1 %
      \dimen0=#1 %
   \fi%
}
...
\protected\def\yquant@softpath@extractmaxxat@lineto#1#2{%
   \pgfpointtransformed{\pgfqpoint{#1}{#2}}%
   \ifyquant@OR{\ifdim\yquant@direction@plus\dimen4>\yquant@direction@plus\dimen0 }%
               {\ifdim\yquant@direction@plus\yquant@pgf@x>\yquant@direction@plus\dimen0 }{%
      \ifdim\dimen6=\dimen2 %
...
\protected\def\yquant@softpath@extractmaxxat@rectto#1#2\pgfsyssoftpath@rectsizetoken#3#4{%
   ...
   \ifdim\yquant@pgf@y>\pgf@ya %
      \unless\ifdim\pgf@ya>\dimen2 %
         \unless\ifdim\yquant@pgf@y<\dimen2 %
            \ifdim\yquant@direction@plus\yquant@pgf@x>\yquant@direction@plus\pgf@xa %
