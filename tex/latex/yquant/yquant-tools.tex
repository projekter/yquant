...
\protected\def\yquant@softpath@extractmaxxat@lineto#1#2{%
   ...
   \ifyquant@OR{\ifdim\yquant@orientation@plus\dimen4>\yquant@orientation@plus\dimen0 }%
      ...
      \ifyquant@AND{\unless\ifdim\dimexpr\dimen6-\yquant@softpath@extracttol\relax>\dimen2 }%
                   {\unless\ifdim\dimexpr\dimen6+\yquant@softpath@extracttol\relax<\dimen2 }{%
...
\protected\def\yquant@softpath@extractmaxxat@curveto@checkx{%
   ...
   \ifyquant@AND{\unless\ifdim\dimen11<0pt }{\unless\ifdim\dimen11>1pt }{%
...
\protected\def\yquant@softpath@extractmaxxat@curveto#1#2\pgfsyssoftpath@curvetosupportbtoken#3#4\pgfsyssoftpath@curvetotoken#5#6{%
   ...
   \begingroup%
      ...
      \ifyquant@AND{\ifdim\dimen1<1pt }{\ifdim\dimen1>-1pt }{%
         ...
         \ifyquant@AND{\ifdim\dimen3<1pt }{\ifdim\dimen3>-1pt }{%
