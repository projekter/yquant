...
\long\def\@twooffive#1#2#3#4#5{{#1}{#2}}
\long\def\@lasttwooffive#1#2#3#4#5{{#4}{#5}}
   ...
   \else%
      ...
      \loop%
         \ifnum\count0<\yquant@sort@count%
            ...
            \expandafter\expandafter\expandafter%
               \relax{%
               \letcs\yquant@sort@min{yquant@sort@item\the\count0}%
            }%
            \advance\count0 by 1 %
      \repeat%
   \fi%
...
\protected\gdef\yquant@list@eupdateorinsert#1#2#3{%
   ...
   \expandafter\etb@tempa\expandafter|#1|#2|&%
}
