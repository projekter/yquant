...
\def\yquant@env@prefix@id#1{\romannumeral-`0\expandafter\yquant@env@prefix@id@\romannumeral-`0#1}
\def\yquant@env@prefix@id@ yquant@env#1@{#1}
\def\yquant@env@prefix@csid#1{\yquant@env@prefix@id{\csname#1\endcsname}}
