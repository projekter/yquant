...
\protected\def\yquant@env@secondpass#1#2{%
...
\fi{%
   ...
   \protected\def\yquant@env@substbeamer#1#2{%
            ...
            \beamer@altget%
               ...
               {%
                  \begingroup%
                     ...
                     ##2{#1##3\yquant@env@beamer@checkifactive}%
      ...
      \mode<article>{
         \newcommand<>{\yquant@env@beamer@note@}[2][]{#2}
      }
   ...
   \def\yquant@env@beamer@uncover\uncover{\yquant@env@beamer@uncover@}
   ...
   \mode<article>{
      \def\yquant@env@beamer@uncover{\yquant@env@beamer@alt@argb{\@firstofone}{\@gobble}}
      \def\yquant@env@beamer@visible{\yquant@env@beamer@alt@argb{\@firstofone}{\@gobble}}
      \def\yquant@env@beamer@invisible{\yquant@env@beamer@alt@argb{\@gobble}{\@firstofone}}
      \newcommand<>\yquant@env@beamer@noargsonslide[2]{}
      \newrobustcmd\yquant@env@beamer@pause@[1][]{}
   }
