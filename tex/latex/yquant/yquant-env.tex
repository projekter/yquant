...
\protected\def\yquant@env@end@calcypositions@setupmulti#1#2{%
   \yquant@sort@eadd{%
      {#1}%
      {\i}%
      {\expandafter\@firstoftwo\yquant@env@end@calcypositions@setupmulti@group#2}%
      {\expandafter\@secondoftwo\yquant@env@end@calcypositions@setupmulti@group#2}%
   }%
}

\def\yquant@env@end@calcypositions@setupmulti@group#1#{{#1}}
...
\def\yquant@env@end@calcypositions@sortmulti#1#2{%
   ...
   \ifdim\dimexpr\@fourthoffour#2-\yquant@env@end@calcypositions@multiheight#2\relax>%
      \dimexpr\@fourthoffour#1-\yquant@env@end@calcypositions@multheight#1\relax%
      \expandafter\@firstoftwo%
   \else%
      \expandafter\@secondoftwo%
   \fi%
