...
\begin{document}
   ...
   \section{Introduction}
      ...
      This alpha version~0.2 \emph{should} be stable and interfaces are not very likely to change in an incompatible way in the future.
      ...
      \subsection{Installation}
         \Yquant{} is available on the CTAN.
         A direct installation from this Git repository is possible by just cloning it to a path visible to your \TeX{} compiler.
...
\end{tikzpicture}
      ...
      \subsection{Defining own gates}
         Since version~0.2, \Yquant{} provides a simple macro that allows the definition of own gates.
